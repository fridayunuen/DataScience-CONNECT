...
path_out = Dir.carpeta_intupt
# path_out = os.path.join(mapping + '\out')

#-----------------#
#posicion_mapping = mapping.find("\Mapping")
#carpeta = mapping[:posicion_mapping]
#path_input = os.path.join(carpeta + '\input')

nom_items_mapping = os.path.join(path_out, 'Mapping.csv')
#nom_items_mapping_input = os.path.join(path_input, 'Mapping.csv')


df = map_files(path_fotos, saveas=nom_items_mapping)
#map_files(path_fotos, saveas=nom_items_mapping_input)
